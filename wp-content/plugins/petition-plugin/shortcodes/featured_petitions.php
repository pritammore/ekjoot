...
add_action( 'vc_before_init', 'conikal_vc_featured_petitions_shortcode' );
function conikal_vc_featured_petitions_shortcode() {
   vc_map( array(
      "name" => __('Featured Petition', 'petition'),
      "base" => 'featured_petitions',
      "class" => '',
