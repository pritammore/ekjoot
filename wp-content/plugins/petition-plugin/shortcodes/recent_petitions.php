...
add_action( 'vc_before_init', 'conikal_vc_recent_petitions_shortcode' );
function conikal_vc_recent_petitions_shortcode() {
   vc_map( array(
      "name" => __('Recent Petition', 'petition'),
      "base" => 'recent_petitions',
      "class" => '',
