...
if( !function_exists('conikal_featured_posts_shortcode') ): 
    function conikal_featured_posts_shortcode($attrs, $content = null) {
        ...
        foreach($posts as $post) : 
            ...
            $return_string .= '<a href="' . esc_url($post_link) . '" class="image blurring" data-bjax>';
...
add_action( 'vc_before_init', 'conikal_vc_featured_posts_shortcode' );
function conikal_vc_featured_posts_shortcode() {
   vc_map( array(
      "name" => __('Featured Posts', 'petition'),
      "base" => 'featured_posts',
      "class" => '',
