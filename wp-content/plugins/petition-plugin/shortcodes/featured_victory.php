...
add_action( 'vc_before_init', 'conikal_vc_featured_victory_shortcode' );
function conikal_vc_featured_victory_shortcode() {
   vc_map( array(
      "name" => __('Featured Victory Petition', 'petition'),
      "base" => 'featured_victory',
      "class" => '',
