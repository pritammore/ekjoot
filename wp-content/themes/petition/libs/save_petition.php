...
if( !function_exists('conikal_save_petition') ): 
    function conikal_save_petition() {
        ...
        $sendinblue_list = isset($_POST['sendinblue_list']) ? sanitize_text_field($_POST['sendinblue_list']) : '';
        ...
        update_post_meta($prop_id, 'petition_sendinblue_list', $sendinblue_list);
        ...
        if ($approve == 'pending') {
            ...
            if ($new_id != '') {
                $prop_link = add_query_arg(array('action' => 'updated'), $prop_link);
            } 
        }
...
if( !function_exists('conikal_update_letter') ): 
    function conikal_update_letter() {
        ...
        $letter = isset($_POST['letter']) ? sanitize_textarea_field($_POST['letter']) : '';
        ...
        $content = wpautop($letter);
        
        echo json_encode(array('save'=>true, 'content' => $content, 'message' => 'The petition was successfully saved'));
