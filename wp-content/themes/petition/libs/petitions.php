...
// RECENT PETITION FUNCTION
if( !function_exists('conikal_recent_petitions') ): 
    function conikal_recent_petitions() {
...
// LOAD MORE RECENT PETITION
if( !function_exists('conikal_load_recent_petitions') ): 
    function conikal_load_recent_petitions() {
...
add_action( 'wp_ajax_nopriv_conikal_load_recent_petitions', 'conikal_load_recent_petitions' );
add_action( 'wp_ajax_conikal_load_recent_petitions', 'conikal_load_recent_petitions' );
