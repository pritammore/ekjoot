...
class Recent_Petitions_Widget extends WP_Widget {
    function __construct() {
        $widget_ops = array('classname' => 'recent_petitions_sidebar', 'description' => 'Recently petitions.');
        $control_ops = array('id_base' => 'recent_petitions_widget');
        parent::__construct('recent_petitions_widget', 'Petition WP Recently', $widget_ops, $control_ops);
    }
    ...
    function update($new_instance, $old_instance) {
        ...
        if(function_exists('icl_register_string')) {
            icl_register_string('conikal_recent_petitions_widget', 'recent_petitions_widget_title', sanitize_text_field($new_instance['title']));
            icl_register_string('conikal_recent_petitions_widget', 'recent_petitions_widget_limit', sanitize_text_field($new_instance['limit']));
        }
