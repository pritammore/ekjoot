...
class Recent_Posts_Widget extends WP_Widget {
    function __construct() {
        $widget_ops = array('classname' => 'recent_posts_sidebar', 'description' => 'Petition posts recently.');
        $control_ops = array('id_base' => 'recent_posts_sidebar');
        parent::__construct('recent_posts_sidebar', 'Petition WP Posts Recently', $widget_ops, $control_ops);
    }
    ...
    function update($new_instance, $old_instance) {
        ...
        if(function_exists('icl_register_string')) {
            icl_register_string('conikal_recent_posts_widget', 'recent_posts_widget_title', sanitize_text_field($new_instance['title']));
            icl_register_string('conikal_recent_posts_widget', 'recent_posts_widget_limit', sanitize_text_field($new_instance['limit']));
            icl_register_string('conikal_recent_posts_widget', 'recent_posts_widget_limit', sanitize_text_field($new_instance['link_only']));
        }
