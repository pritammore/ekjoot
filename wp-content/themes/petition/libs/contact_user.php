    ...
    function conikal_send_message_to_user() {
        ...
        if($client_message_for == 'RequestUICSupport') {
            if(validate_uic($uic)){
                ...
                $client_message = get_email_tempalte($client_message_for, $uic, $user_email);
            } else {
...
if( !function_exists('conikal_send_invatation') ): 
    function conikal_send_invatation() {
        ...
        $invite_message = get_template_for_invite(nl2br($invite_message), $user_email);
...
function get_email_tempalte($client_message_for, $uic, $user_email) {
    ...
    $admin_email_for_footer = get_option( 'admin_email' );
                                ...
                                <tr>
                                  <td align='left' style='font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;'>
                                    <table border='0' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;'>
                                      <tbody>
                                        <tr>
                                          <td style='font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #8a8a8a; border-radius: 5px; text-align: center;'> <a href='". $petition['url'] ."' target='_blank' style='display: inline-block; color: #ffffff; background-color: #8a8a8a; border: solid 1px #8a8a8a; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #8a8a8a;'>Lead this Issue</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
                  ...
                  <table border='0' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;'>
                    ...
                    <tr>
                      <td class='content-block powered-by' style='font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;'>
                        Powered by <a href='mailto:". $admin_email_for_footer ."' style='color: #999999; font-size: 12px; text-align: center; text-decoration: none;'>" . $site_name . "</a>.
                      </td>
                    </tr>
                  </table>
                </div>
...
function get_template_for_invite($invite_message,$user_email)
{
  $email_template = '';
    $conikal_general_settings = get_option('conikal_general_settings','');
    $logo = isset($conikal_general_settings['conikal_logo_field']) ? $conikal_general_settings['conikal_logo_field'] : '';
    ...
    $site_name = get_bloginfo();
    $email_template = "
    <!doctype html><html><head><meta name='viewport' content='width=device-width'><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'><title>Simple Transactional Email</title><style>
        @media only screen and (max-width: 620px) {
          table[class=body] h1 {
            font-size: 28px !important;
            margin-bottom: 10px !important;
