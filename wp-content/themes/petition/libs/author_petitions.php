...
// GET QUERY AUTHOR PETITION

if( !function_exists('conikal_author_petitions') ): 
    function conikal_author_petitions($user_id) {
...
// LOAD MORE AUTHOR PETITION

if( !function_exists('conikal_load_author_petitions') ): 
    function conikal_load_author_petitions() {
...
add_action( 'wp_ajax_nopriv_conikal_load_author_petitions', 'conikal_load_author_petitions' );
add_action( 'wp_ajax_conikal_load_author_petitions', 'conikal_load_author_petitions' );
