...
if ($body_font_family != '') {
	print '
		body {
			font-family: ' . $body_font_family[0] . ', "Helvetica Neue", Helvetica, ' . $body_font_family[1] . ' !important;
			font-weight: ' . $body_font_weight . ';
			line-height: ' . $body_font_line . 'px;
		...
		.ui.menu, .ui.inline.dropdown>.text {
			font-family: ' . $body_font_family[0] . ', "Helvetica Neue", Helvetica, ' . $body_font_family[1] . ' !important;
			font-weight: ' . $body_font_weight . ';
		}
	';
...
if ($home_heading_font_family != '') {
	print '
		.home-title {
			font-family: ' . $home_heading_font_family[0] . ', "Helvetica Neue", Helvetica, ' . $home_heading_font_family[1] . ' !important;
			font-weight: ' . $home_heading_font_weight . ';
			line-height: ' . $home_heading_font_line . 'px;
			font-size: ' . $home_heading_font_size . 'px;
		}
	';
}
...
if ($home_subheading_font_family != '') {
	print '
		.home-subtitle {
			font-family: ' . $home_subheading_font_family[0] . ', "Helvetica Neue", Helvetica, ' . $home_subheading_font_family[1] . ' !important;
			font-weight: ' . $home_subheading_font_weight . ';
			line-height: ' . $home_subheading_font_line . 'px;
			font-size: ' . $home_subheading_font_size . 'px;
		}
	';
}
...
if ($heading_font_family != '') {
	print '
		.ui.header {
			font-family: ' . $heading_font_family[0] . ', "Helvetica Neue", Helvetica, ' . $heading_font_family[1] . ' !important;
			font-weight: ' . $heading_font_weight . ';
			line-height: ' . $heading_font_line . 'px;
...
if ($page_heading_font_family != '') {
	print '
		.petition-title .content, .page-title, .post-title {
			font-family: ' . $page_heading_font_family[0] . ', "Helvetica Neue", Helvetica, ' . $page_heading_font_family[1] . ' !important;
			font-weight: ' . $page_heading_font_weight . ' !important;
			line-height: ' . $page_heading_font_line . 'px !important;
			font-size: ' . $page_heading_font_size . 'px !important;
		}
	';
}
...
if ($widget_title_font_family != '') {
	print '
		.widget-title {
			font-family: ' . $widget_title_font_family[0] . ', "Helvetica Neue", Helvetica, ' . $widget_title_font_family[1] . ' !important;
			font-weight: ' . $widget_title_font_weight . ' !important;
			line-height: ' . $widget_title_font_line . 'px !important;
			font-size: ' . $widget_title_font_size . 'px !important;
		}
	';
}
...
if ($posts_title_font_family != '') {
	print '
		.list-petition-title, .victory-title {
			font-family: ' . $posts_title_font_family[0] . ', "Helvetica Neue", Helvetica, ' . $posts_title_font_family[1] . ' !important;
			font-weight: ' . $posts_title_font_weight . ' !important;
			line-height: ' . $posts_title_font_line . 'px !important;
			font-size: ' . $posts_title_font_size . 'px !important;
		}
		.card-post-title, .card-petition-title {
			font-family: ' . $posts_title_font_family[0] . ', "Helvetica Neue", Helvetica, ' . $posts_title_font_family[1] . ' !important;
			font-weight: ' . $posts_title_font_weight . ' !important;
			line-height: ' . ($posts_title_font_line - 2) . 'px !important;
			font-size: ' . ($posts_title_font_size - 2) . 'px !important;
		}
	';
}
...
if ($content_font_family != '') {
	print '
		.entry-content {
			font-family: ' . $content_font_family[0] . ', "Helvetica Neue", Helvetica, ' . $content_font_family[1] . ' !important;
			font-weight: ' . $content_font_weight . ' !important;
			line-height: ' . $content_font_line . 'px !important;
...
if ($button_font_family != '') {
	print '
		button, .ui.button, .ui.label {
			font-family: ' . $button_font_family[0] . ', "Helvetica Neue", Helvetica, ' . $button_font_family[1] . ' !important;
