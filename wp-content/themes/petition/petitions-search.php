...
if ($arrayPetitions) {
    echo json_encode(array('status' => true, 'total' => $petitions->found_posts, 'results' => $arrayPetitions, 'message' => __('Petitions was loaded successfully.', 'petition'), 'action' => array('url' => $page_link, 'text' => __('View ', 'petition') . $petitions->found_posts . __(' results for ', 'petition') . '"' . $keyword . '"' ) ));
    exit();
} else {
